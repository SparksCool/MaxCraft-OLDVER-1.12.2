...
public class VillageBankHouse extends StructureVillagePieces.House1 {
    ...
    public VillageBankHouse() {

    }

    public VillageBankHouse(StructureBoundingBox boundingBox, EnumFacing par5) {
        this.setCoordBaseMode(par5);
        this.boundingBox = boundingBox;
    }

    public static VillageBankHouse buildComponent(List<StructureComponent> pieces, int p1, int p2, int p3, EnumFacing p4) {
        ...
        return canVillageGoDeeper(boundingBox) && StructureComponent.findIntersecting(pieces, boundingBox) == null ? new VillageBankHouse(boundingBox, p4) : null;
    }
    ...
    protected VillagerProfession chooseForgeProfession(int count, VillagerProfession prof) {
        return BankerVillager.bankerProfession;
    }
